...
#solution(users.ranolp)[
  ...
  #diagram(
    node((0, 3), $X times Y$),
    edge((0, 3), (3, 2), $f compose p^(X, Y)_1$, "->", label-sep: 12pt, bend: 70deg, label-side: right),
    edge((0, 3), (3, 4), $g compose p^(X, Y)_2$, "->", label-sep: 12pt, bend: -74deg, label-side: left),
  ...
  Now all we need to do is to check that $F$ is functor.
    ...
    *Preservation of Identity*
    ...
    #diagram(
      node((0, 3), $X times Y$),
      edge((0, 3), (3, 2), $id_X compose p^(X, Y)_1$, "->", label-sep: 12pt, bend: 70deg, label-side: right),
      edge((0, 3), (3, 4), $id_Y compose p^(X, Y)_2$, "->", label-sep: 12pt, bend: -74deg, label-side: left),
      edge((0, 3), (1, 2), $p^(X, Y)_1$, "->", label-sep: -4pt),
      ...
      node((3, 2), $X$),
      edge((2, 3), (3, 4), $p^(X, Y)_2$, "->", label-sep: 2pt, label-side: right),
      node((3, 4), $Y$),
    )
    ...
    *Preservation of Composition*
    ...
    #diagram(
      ...
      edge((2, 3 - .5), (3, 4), $p^(Z, W)_2$, "->", label-sep: 2pt, label-pos: 75%, label-side: right),
      node((3, 4), $W$),
      edge((3, 4), (5, 4), $g_2$, "->", label-sep: 2pt, label-side: right),
      node((4, 3), $A times B$),
      edge((4, 3), (5, 2), $p^(A, B)_1$, "->", label-sep: -4pt),
      node((5, 2), $A$),
      edge((4, 3), (5, 4), $p^(A, B)_2$, "->", label-sep: 2pt, label-side: right),
      node((5, 4), $B$),
    )
