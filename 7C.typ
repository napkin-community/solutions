...
#solution(users.kiwiyou)[
  For every $q != p$, there exist two open neighbourhoods $U$ of $p$ and $V$ of $q$ s.t. $U inter V = nothing$.

  #plain_box(title: [Definition 7.3.1], subtitle: [Hausdorff])[
    A topological space $X$ is #glossary[Hausdorff] if for any two distinct points $p, q in X$, there exist two open neighbourhoods $U$ of $p$ and $V$ of $q$ such that $ U inter V = nothing. $
  ]
